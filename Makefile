...
SIMAPP = ./app
HTTPS_GIT := https://github.com/servprotocolorg/ethermint.git
...
PACKAGE_NAME:=github.com/servprotocolorg/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/servprotocolorg/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/servprotocolorg/ethermint/tests/importer
